...
//    return;
//}
//void bin_a_txt(const char nombre_archivo_txt[30],const char nombre_archivo_bin[30]){
...
//}
//
//void bin_a_txt_bajas(const char nombre_archivo_txt[30],const char nombre_archivo_bin[30]){
...
//        printf("11. Migrar datos binario al archivo TXT \n");
//        printf("12. Salir\n");
